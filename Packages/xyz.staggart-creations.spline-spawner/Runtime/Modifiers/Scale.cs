...
namespace sc.splines.spawner.runtime
{
    ...
    public class Scale : Modifier
    {
        ...
        //Randomization
        public float randomUniformMin = 1f;
        public float randomUniformMax = 1f;
        
        public Vector3 randomAxisMin = Vector3.one;
        public Vector3 randomAxisMax = Vector3.one;
        ...
        public static Scale CreateRandomScale()
        {
            Scale scale = new Scale()
            {
                randomUniformMin = 0.8f,
                randomUniformMax = 1.2f
            };
