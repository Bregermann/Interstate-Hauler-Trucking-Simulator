...
namespace sc.splines.spawner.runtime
{
    ...
    public class SplineInstanceContainer : MonoBehaviour
    {
        ...
        public GameObject SpawnObject(SpawnPoint spawnPoint, GameObject prefab, Transform root, bool hide, bool applyRootStaticFlags, int staticFlags)
        {
            ...
            {
                GameObjectUtility.SetStaticEditorFlags(instance, (StaticEditorFlags)staticFlags);
            }
            #endif
        ...
        public void ClearUnusedObjects()
        {
            ...
            #if UNITY_EDITOR
            //Edge case, when exiting a prefab editor
            if (this == null) return;
            #endif
