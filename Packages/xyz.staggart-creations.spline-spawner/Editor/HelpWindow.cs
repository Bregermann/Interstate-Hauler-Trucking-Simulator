...
namespace sc.splines.spawner.editor
{
    public class HelpWindow : EditorWindow
    {
        ...
        [MenuItem("Window/"+ AssetInfo.ASSET_NAME + "/Help Window", false, 1000)]
        ...
        {
            string path = AssetDatabase.GUIDToAssetPath("7f3c2d66b1ca2f64a97a401141a1903f");
        ...
        [MenuItem("Window/"+ AssetInfo.ASSET_NAME + "/Edit Layer Names", false, 2000)]
        ...
        private void OnGUI()
        {
            ...
            using (new EditorGUILayout.VerticalScope(UI.Styles.Section))
            {
                ...
                UI.DrawH2("Other spline tools");
                
                UI.DrawAsset("Spline Mesher Pro", 338468,
                    "Easily bend and repeat meshes along Unity splines for fences, pipes, paths, and more - or generate a mesh from a spline area." +
                            "\n\n" +
                            "Fast, flexible, and built on Unity’s native spline system.");
            }
        }
