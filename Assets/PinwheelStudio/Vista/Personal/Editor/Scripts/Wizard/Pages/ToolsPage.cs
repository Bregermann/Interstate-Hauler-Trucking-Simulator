...
namespace Pinwheel.VistaEditor.Wizard
{
    ...
    public class ToolsPage : HubPage, INavLevelPage
    {
        ...
        protected override void BuildTitleStripActions(VisualElement container)
        {
            ...
            availability.Add(VistaUI.Clickable("Compare Editions", OpenEditionComparison).Link());
        ...
        private static void OpenEditionComparison()
        {
            NetUtils.TrackClick("compare-editions", UILocation.Wizard_Tools);
            Application.OpenURL(Links.VISTA_COMPARE_EDITIONS);
        }
