...
namespace sc.modeling.river.runtime
{
    public partial class RiverModeler
    {
        ...
        public void TryGetMicroVerseSplinePath()
        {
            #if MICROVERSE_SPLINES && SPLINES && MATHEMATICS
            SplinePath splinePath = splineContainer.GetComponent<SplinePath>();
            
            if(splinePath) microVerseSettings.splinePath = splinePath;
            #endif
        }
        ...
        public partial void UpdateMicroVerseSpline()
        {
            ...
            SplinePath splinePath = microVerseSettings.splinePath;
            //if(!splinePath) splinePath = splineContainer.GetComponent<SplinePath>();
