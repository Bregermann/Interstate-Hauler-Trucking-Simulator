...
namespace CompassNavigatorPro {
    ...
    public class CompassNavigatorProInspector : Editor {
        ...
        bool expandGeneralSettings, expandCompassBarSettings, expandMiniMapSettings, expandOnScreenIndicatorSettings, expandOffScreenIndicatorSettings, expandScanSettings, expandRouteSettings;
        ...
        SerializedProperty compassShowPOIs, compassIconPrefab, minIconSize, maxIconSize, visibleMaxDistance, visibleMinDistance, nearDistance, visitedDistance, scaleInDuration, focusedPOI, labelHotZone, visitedDefaultAudioClip, beaconDefaultAudioClip, heartbeatDefaultAudioClip;
        ...
        SerializedProperty miniMapShowPOIs, miniMapIconPrefab, miniMapVisibleMaxDistance, miniMapIconSize, miniMapIconPositionShift;
        ...
        SerializedProperty routeUseWaypoints, routeWaypoints, routeShowWaypointMarkers, routeWaypointMarkerSize, routeWorldShowWaypointMarkers, routeWorldWaypointMarkerSize, routeWorldWaypointMarkerYOffset, routeHideTraveledWaypointMarkers;
        SerializedProperty showRoute, routeShowOnMiniMap, routeShowOnCompassBar, routeCueShowOnMiniMap, routeColor, routeUseGradient, routeGradientColor, routeShowTraveled, routeTraveledColor, routeTraveledSolid, routeAutoProgress, routeWidth, routeWidthSpace, routeTexture, routeTextureTilingSpace, routeTextureTiling, routeEdgeFeather, routeFlowSpeed, routeCompassBarSprite, routeWaypointTitle, routeAutoAdvance, routeWaypointReachDistance, routeClearOnComplete, routeMaxSegments, routeShowInWorld, routeWorldEditPreview, routeWorldWidth, routeWorldAlwaysVisible, routeWorldGroundMode, routeWorldFixedHeight, routeWorldGroundMask, routeWorldYOffset, routeWorldSampleStep, routeWorldFlowSpeed, routeWorldEdgeFeather, routeWorldMaxDistance, routeWorldMinDistance, routeWorldFadeDistance, routeWorldShowTraveled, routeWorldTraveledColor, routeWorldTexture, routeWorldTextureLength, routeCornerRadius, routeSmoothing, routeCurveResolution;
        SerializedProperty OnRouteUpdated, OnRouteWaypointReached, OnRouteCompleted, OnRouteCleared;
        ...
        void OnEnable () {
            ...
            compassShowPOIs = serializedObject.FindProperty("_compassShowPOIs");
            ...
            miniMapShowPOIs = serializedObject.FindProperty("_miniMapShowPOIs");
            ...
            expandRouteSettings = EditorPrefs.GetBool("CNProRouteSettings", false);

            showRoute = serializedObject.FindProperty("_showRoute");
            routeUseWaypoints = serializedObject.FindProperty("_routeUseWaypoints");
            routeWaypoints = serializedObject.FindProperty("_routeWaypoints");
            routeShowWaypointMarkers = serializedObject.FindProperty("_routeShowWaypointMarkers");
            routeWaypointMarkerSize = serializedObject.FindProperty("_routeWaypointMarkerSize");
            routeShowOnMiniMap = serializedObject.FindProperty("_routeShowOnMiniMap");
            routeShowOnCompassBar = serializedObject.FindProperty("_routeShowOnCompassBar");
            routeCueShowOnMiniMap = serializedObject.FindProperty("_routeCueShowOnMiniMap");
            routeWaypointTitle = serializedObject.FindProperty("_routeWaypointTitle");
            routeColor = serializedObject.FindProperty("_routeColor");
            routeTexture = serializedObject.FindProperty("_routeTexture");
            routeUseGradient = serializedObject.FindProperty("_routeUseGradient");
            routeGradientColor = serializedObject.FindProperty("_routeGradientColor");
            routeShowTraveled = serializedObject.FindProperty("_routeShowTraveled");
            routeTraveledColor = serializedObject.FindProperty("_routeTraveledColor");
            routeTraveledSolid = serializedObject.FindProperty("_routeTraveledSolid");
            routeAutoProgress = serializedObject.FindProperty("_routeAutoProgress");
            routeWidth = serializedObject.FindProperty("_routeWidth");
            routeWidthSpace = serializedObject.FindProperty("_routeWidthSpace");
            routeTextureTilingSpace = serializedObject.FindProperty("_routeTextureTilingSpace");
            routeTextureTiling = serializedObject.FindProperty("_routeTextureTiling");
            routeEdgeFeather = serializedObject.FindProperty("_routeEdgeFeather");
            routeFlowSpeed = serializedObject.FindProperty("_routeFlowSpeed");
            routeCompassBarSprite = serializedObject.FindProperty("_routeCompassBarSprite");
            routeAutoAdvance = serializedObject.FindProperty("_routeAutoAdvance");
            routeWaypointReachDistance = serializedObject.FindProperty("_routeWaypointReachDistance");
            routeClearOnComplete = serializedObject.FindProperty("_routeClearOnComplete");
            routeHideTraveledWaypointMarkers = serializedObject.FindProperty("_routeHideTraveledWaypointMarkers");
            routeMaxSegments = serializedObject.FindProperty("_routeMaxSegments");
            routeShowInWorld = serializedObject.FindProperty("_routeShowInWorld");
            routeWorldEditPreview = serializedObject.FindProperty("_routeWorldEditPreview");
            routeWorldShowWaypointMarkers = serializedObject.FindProperty("_routeWorldShowWaypointMarkers");
            routeWorldWaypointMarkerSize = serializedObject.FindProperty("_routeWorldWaypointMarkerSize");
            routeWorldWaypointMarkerYOffset = serializedObject.FindProperty("_routeWorldWaypointMarkerYOffset");
            routeWorldWidth = serializedObject.FindProperty("_routeWorldWidth");
            routeWorldAlwaysVisible = serializedObject.FindProperty("_routeWorldAlwaysVisible");
            routeWorldGroundMode = serializedObject.FindProperty("_routeWorldGroundMode");
            routeWorldFixedHeight = serializedObject.FindProperty("_routeWorldFixedHeight");
            routeWorldGroundMask = serializedObject.FindProperty("_routeWorldGroundMask");
            routeWorldYOffset = serializedObject.FindProperty("_routeWorldYOffset");
            routeWorldSampleStep = serializedObject.FindProperty("_routeWorldSampleStep");
            routeWorldFlowSpeed = serializedObject.FindProperty("_routeWorldFlowSpeed");
            routeWorldEdgeFeather = serializedObject.FindProperty("_routeWorldEdgeFeather");
            routeWorldMaxDistance = serializedObject.FindProperty("_routeWorldMaxDistance");
            routeWorldMinDistance = serializedObject.FindProperty("_routeWorldMinDistance");
            routeWorldFadeDistance = serializedObject.FindProperty("_routeWorldFadeDistance");
            routeWorldShowTraveled = serializedObject.FindProperty("_routeWorldShowTraveled");
            routeWorldTraveledColor = serializedObject.FindProperty("_routeWorldTraveledColor");
            routeWorldTexture = serializedObject.FindProperty("_routeWorldTexture");
            routeWorldTextureLength = serializedObject.FindProperty("_routeWorldTextureLength");
            routeCornerRadius = serializedObject.FindProperty("_routeCornerRadius");
            routeSmoothing = serializedObject.FindProperty("_routeSmoothing");
            routeCurveResolution = serializedObject.FindProperty("_routeCurveResolution");
            ...
            // Route events
            OnRouteUpdated = serializedObject.FindProperty("OnRouteUpdated");
            OnRouteWaypointReached = serializedObject.FindProperty("OnRouteWaypointReached");
            OnRouteCompleted = serializedObject.FindProperty("OnRouteCompleted");
            OnRouteCleared = serializedObject.FindProperty("OnRouteCleared");
        ...
        private void OnDisable () {
            ...
            EditorPrefs.SetBool("CNProRouteSettings", expandRouteSettings);
        }
        ...
        public override void OnInspectorGUI () {
            ...
            if (GUILayout.Button("Help", GUILayout.Width(50)))
                Application.OpenURL("https://kronnect.com/docs/compass-4/");
            ...
            EditorGUILayout.PropertyField(showRoute, new GUIContent("Route"));
            EditorGUILayout.Separator();
            ...
            if (showCompassBar.boolValue) {
                ...
                if (expandCompassBarSettings) {
                    ...
                    if (expandCompassPOISettings) {
                        EditorGUILayout.PropertyField(compassShowPOIs, new GUIContent("Show POIs"));
            ...
            if (showMiniMap.boolValue) {
                ...
                if (expandMiniMapSettings) {
                    ...
                    if (expandMiniMapPOISettings) {
                        EditorGUILayout.PropertyField(miniMapShowPOIs, new GUIContent("Show POIs"));
            ...
            if (showRoute.boolValue) {
                expandRouteSettings = DrawSectionTitle("Route Settings", expandRouteSettings);
                if (expandRouteSettings) {
                    // ── Common (apply to mini-map and in-world) ──
                    EditorGUILayout.LabelField("Common", EditorStyles.boldLabel);
                    EditorGUILayout.PropertyField(routeUseWaypoints, new GUIContent("Use Waypoints"));
                    if (routeUseWaypoints.boolValue) {
                        EditorGUI.indentLevel++;
                        EditorGUILayout.PropertyField(routeWaypoints, new GUIContent("Waypoints"), true);
                        EditorGUI.indentLevel--;
                    } else {
                        EditorGUILayout.HelpBox("Set the route at runtime with SetRoute(points) / SetRouteToPOI(poi), or enable Use Waypoints to author it here.", MessageType.None);
                    }
                    EditorGUILayout.PropertyField(routeShowOnCompassBar, new GUIContent("Cue On Compass Bar"));
                    EditorGUILayout.PropertyField(routeCueShowOnMiniMap, new GUIContent("Cue On Mini-Map"));
                    if (routeShowOnCompassBar.boolValue || routeCueShowOnMiniMap.boolValue) {
                        EditorGUI.indentLevel++;
                        EditorGUILayout.PropertyField(routeCompassBarSprite, new GUIContent("Cue Sprite"));
                        EditorGUILayout.PropertyField(routeWaypointTitle, new GUIContent("Cue Title"));
                        EditorGUI.indentLevel--;
                    }
                    EditorGUILayout.PropertyField(routeColor, new GUIContent("Route Color"));
                    EditorGUILayout.PropertyField(routeUseGradient, new GUIContent("Use Gradient"));
                    if (routeUseGradient.boolValue) {
                        EditorGUI.indentLevel++;
                        EditorGUILayout.PropertyField(routeGradientColor, new GUIContent("Destination Color"));
                        EditorGUI.indentLevel--;
                    }
                    EditorGUILayout.PropertyField(routeShowTraveled, new GUIContent("Color Travelled Part"));
                    if (routeShowTraveled.boolValue) {
                        EditorGUI.indentLevel++;
                        EditorGUILayout.PropertyField(routeTraveledSolid, new GUIContent("Solid"));
                        EditorGUILayout.PropertyField(routeAutoProgress, new GUIContent("Auto Progress"));
                        EditorGUI.indentLevel--;
                    }
                    EditorGUILayout.PropertyField(routeSmoothing, new GUIContent("Smoothing", "Shape of the route line on both the mini-map and in-world: Straight segments, Rounded corners (fillet), or Curved (a spline through every point). Curved bows between points, so it can cut corners on tight NavMesh paths."));
                    if (routeSmoothing.enumValueIndex == (int)RouteSmoothing.Rounded) {
                        EditorGUI.indentLevel++;
                        EditorGUILayout.PropertyField(routeCornerRadius, new GUIContent("Corner Radius", "Rounds bends with a fillet of this radius (m). 0 = sharp corners (bevel-filled)."));
                        EditorGUI.indentLevel--;
                    } else if (routeSmoothing.enumValueIndex == (int)RouteSmoothing.Curved) {
                        EditorGUI.indentLevel++;
                        EditorGUILayout.PropertyField(routeCurveResolution, new GUIContent("Curve Detail", "Subdivisions per segment. Higher = smoother spline, more triangles."));
                        EditorGUI.indentLevel--;
                    }
                    EditorGUILayout.PropertyField(routeAutoAdvance, new GUIContent("Auto Advance"));
                    if (routeAutoAdvance.boolValue) {
                        EditorGUI.indentLevel++;
                        EditorGUILayout.PropertyField(routeWaypointReachDistance, new GUIContent("Reach Distance"));
                        EditorGUILayout.PropertyField(routeClearOnComplete, new GUIContent("Clear On Complete"));
                        EditorGUILayout.PropertyField(routeHideTraveledWaypointMarkers, new GUIContent("Hide Travelled Markers", "Hides the markers of waypoints already reached (the travelled part), on both the mini-map and in-world."));
                        EditorGUI.indentLevel--;
                    }
                    EditorGUILayout.PropertyField(routeMaxSegments, new GUIContent("Max Segments"));

                    // ── Mini-Map ──
                    EditorGUILayout.Space();
                    EditorGUILayout.LabelField("Mini-Map", EditorStyles.boldLabel);
                    EditorGUILayout.PropertyField(routeShowOnMiniMap, new GUIContent("Polyline On Mini-Map"));
                    if (routeShowOnMiniMap.boolValue) {
                        EditorGUI.indentLevel++;
                        EditorGUILayout.PropertyField(routeWidth, new GUIContent("Width"));
                        EditorGUILayout.PropertyField(routeWidthSpace, new GUIContent("Width Space"));
                        EditorGUILayout.PropertyField(routeTexture, new GUIContent("Texture"));
                        if (routeTexture.objectReferenceValue == null) {
                            EditorGUILayout.HelpBox("Tip: the asset includes ready-to-use line textures in Resources/CNPro/Textures: route_arrow, route_arrow_filled, route_dash, route_dot and route_double_line.", MessageType.None);
                        }
                        if (routeTexture.objectReferenceValue != null) {
                            EditorGUI.indentLevel++;
                            EditorGUILayout.PropertyField(routeTextureTiling, new GUIContent("Tiling", "Texture repetitions along the route."));
                            EditorGUILayout.PropertyField(routeTextureTilingSpace, new GUIContent("Tiling Space"));
                            EditorGUILayout.PropertyField(routeFlowSpeed, new GUIContent("Flow Speed"));
                            EditorGUI.indentLevel--;
                        }
                        EditorGUILayout.PropertyField(routeEdgeFeather, new GUIContent("Edge Softness"));
                        if (routeShowTraveled.boolValue) {
                            EditorGUILayout.PropertyField(routeTraveledColor, new GUIContent("Travelled Color"));
                        }
                        EditorGUI.indentLevel--;
                    }
                    EditorGUILayout.PropertyField(routeShowWaypointMarkers, new GUIContent("Show Waypoint Markers"));
                    if (routeShowWaypointMarkers.boolValue) {
                        EditorGUI.indentLevel++;
                        EditorGUILayout.PropertyField(routeWaypointMarkerSize, new GUIContent("Marker Size"));
                        EditorGUI.indentLevel--;
                    }
                    ...
                    EditorGUILayout.PropertyField(routeShowInWorld, new GUIContent("Show Path In World"));
                    if (routeShowInWorld.boolValue) {
                        EditorGUI.indentLevel++;
                        EditorGUILayout.PropertyField(routeWorldEditPreview, new GUIContent("Preview in Edit Mode", "Renders the in-world route line in the Scene view while editing, as a live preview of the authored waypoints, without entering Play mode. No effect in Play mode."));
                        EditorGUILayout.PropertyField(routeWorldWidth, new GUIContent("Width"));
                        EditorGUILayout.PropertyField(routeWorldAlwaysVisible, new GUIContent("Always Visible"));
                        if (routeShowTraveled.boolValue) {
                            EditorGUILayout.PropertyField(routeWorldShowTraveled, new GUIContent("Show Travelled Part", "Colors the already-travelled part of the in-world line. The mini-map keeps its own travelled appearance, so you can show it there but not in-world."));
                            if (routeWorldShowTraveled.boolValue) {
                                EditorGUI.indentLevel++;
                                EditorGUILayout.PropertyField(routeWorldTraveledColor, new GUIContent("Travelled Color", "Color (and alpha) of the already-travelled part of the in-world line. Set alpha to 0 to hide the travelled part in-world only."));
                                EditorGUI.indentLevel--;
                            }
                        }
                        EditorGUILayout.PropertyField(routeWorldMinDistance, new GUIContent("Min Distance", "The in-world line and markers are hidden closer than this distance (m) to the follow target. 0 = visible up to the player."));
                        EditorGUILayout.PropertyField(routeWorldFadeDistance, new GUIContent("Fade Distance", "Width (m) of the fade-in band starting at Min Distance. 0 = hard edge."));
                        EditorGUILayout.PropertyField(routeWorldMaxDistance, new GUIContent("Max Distance", "Fades the line out beyond this distance (m) from the follow target. 0 = no limit."));
                        EditorGUILayout.PropertyField(routeWorldTexture, new GUIContent("Texture"));
                        if (routeWorldTexture.objectReferenceValue != null) {
                            EditorGUI.indentLevel++;
                            EditorGUILayout.PropertyField(routeWorldTextureLength, new GUIContent("Tile Length", "Meters per texture repetition along the route. Set the texture wrap mode to Repeat."));
                            EditorGUILayout.PropertyField(routeWorldFlowSpeed, new GUIContent("Flow Speed"));
                            EditorGUI.indentLevel--;
                        } else {
                            EditorGUILayout.HelpBox("Tip: the asset includes ready-to-use line textures in Resources/CNPro/Textures: route_arrow, route_arrow_filled, route_dash, route_dot and route_double_line.", MessageType.None);
                            EditorGUILayout.PropertyField(routeWorldEdgeFeather, new GUIContent("Edge Softness"));
                        }
                        EditorGUILayout.PropertyField(routeWorldGroundMode, new GUIContent("Ground Projection"));
                        if (routeWorldGroundMode.enumValueIndex == (int)RouteWorldGroundMode.FixedHeight) {
                            EditorGUILayout.PropertyField(routeWorldFixedHeight, new GUIContent("Fixed Height"));
                        } else {
                            EditorGUILayout.PropertyField(routeWorldGroundMask, new GUIContent("Mask"));
                            EditorGUILayout.PropertyField(routeWorldYOffset, new GUIContent("Offset"));
                            EditorGUILayout.PropertyField(routeWorldSampleStep, new GUIContent("Sample Step"));
                        }
                        EditorGUI.indentLevel--;
                    }
                    EditorGUILayout.PropertyField(routeWorldShowWaypointMarkers, new GUIContent("Show Waypoint Markers"));
                    if (routeWorldShowWaypointMarkers.boolValue) {
                        EditorGUI.indentLevel++;
                        EditorGUILayout.PropertyField(routeWorldWaypointMarkerSize, new GUIContent("Marker Size"));
                        EditorGUILayout.PropertyField(routeWorldWaypointMarkerYOffset, new GUIContent("Y Offset", "Raises or lowers the in-world marker icon above the ground."));
                        EditorGUI.indentLevel--;
                    }

                    EditorGUILayout.HelpBox("Set the route at runtime with SetRoute(points), SetRouteToPOI(poi) or SetRouteToDestination(pos). Add a CompassProNavMeshRoute component for automatic NavMesh paths.", MessageType.Info);
                }
                EditorGUILayout.Separator();
            }
            ...
            if (expandEventsSection) {
                ...
                EditorGUILayout.LabelField("Route Events", EditorStyles.boldLabel);
                EditorGUILayout.PropertyField(OnRouteUpdated, new GUIContent("On Route Updated"));
                EditorGUILayout.PropertyField(OnRouteWaypointReached, new GUIContent("On Route Waypoint Reached"));
                EditorGUILayout.PropertyField(OnRouteCompleted, new GUIContent("On Route Completed"));
                EditorGUILayout.PropertyField(OnRouteCleared, new GUIContent("On Route Cleared"));
            }
