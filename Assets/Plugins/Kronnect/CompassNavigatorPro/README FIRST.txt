...
* Support-Web: https://kronnect.com/docs/compass-4/
...
Version 6.0
- New feature: Route - shows an animated, guided path to a destination on the mini-map plus a directional cue on the compass bar
- Added a global "Show POIs" toggle for the mini-map
- Added a global "Show POIs" toggle for the compass bar
...
- New documentation: https://kronnect.com/docs/compass-4/code-customization
