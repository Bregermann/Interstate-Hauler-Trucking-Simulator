...
namespace CompassNavigatorPro {
    ...
    public partial class CompassPro : MonoBehaviour {
        ...
        /// <summary>
        /// Event fired when the route is set or updated
        /// </summary>
        public UnityEvent OnRouteUpdated;

        /// <summary>
        /// Event fired when a route waypoint is reached (auto-advance). Sends the waypoint index and its world position
        /// </summary>
        public UnityEvent<int, Vector3> OnRouteWaypointReached;

        /// <summary>
        /// Event fired when the last waypoint of the route is reached
        /// </summary>
        ...
        /// </summary>
        public UnityEvent OnRouteCleared;
