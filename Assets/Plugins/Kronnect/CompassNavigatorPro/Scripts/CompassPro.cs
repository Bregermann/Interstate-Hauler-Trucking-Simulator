...
namespace CompassNavigatorPro {
    ...
    public partial class CompassPro : MonoBehaviour {
        ...
        [Tooltip("Globally shows or hides all POI icons on the compass bar at once. Does not affect the route cue.")]
        [SerializeField]
        bool _compassShowPOIs = true;

        /// <summary>
        /// Globally shows or hides all POI icons on the compass bar. The route cue is controlled by its own setting.
        /// </summary>
        public bool compassShowPOIs {
            get { return _compassShowPOIs; }
            set {
                if (value != _compassShowPOIs) {
                    _compassShowPOIs = value;
                    needUpdateCompassBarIcons = true;
                }
            }
        }
