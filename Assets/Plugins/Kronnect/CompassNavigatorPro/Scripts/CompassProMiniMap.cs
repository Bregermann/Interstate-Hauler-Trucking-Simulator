...
namespace CompassNavigatorPro {
    ...
    public partial class CompassPro : MonoBehaviour {
        ...
        [Tooltip("Globally shows or hides all POI icons on the mini-map at once. Does not affect the route cue.")]
        [SerializeField]
        bool _miniMapShowPOIs = true;

        /// <summary>
        /// Globally shows or hides all POI icons on the mini-map. The route cue is controlled by its own setting.
        /// </summary>
        public bool miniMapShowPOIs {
            get { return _miniMapShowPOIs; }
            set {
                if (value != _miniMapShowPOIs) {
                    _miniMapShowPOIs = value;
                    needUpdateMiniMapIcons = true;
                }
            }
        }
