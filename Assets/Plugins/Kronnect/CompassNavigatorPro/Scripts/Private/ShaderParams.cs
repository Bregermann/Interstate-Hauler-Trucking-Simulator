...
namespace CompassNavigatorPro {
        ...
        static class ShaderParams {
            ...
            // route overlay
            public static int RouteData = Shader.PropertyToID("_RouteData");
            public static int RouteStyleId = Shader.PropertyToID("_RouteStyle");
            public static int RouteFlowId = Shader.PropertyToID("_RouteFlow");
            public static int RouteProgress = Shader.PropertyToID("_RouteProgress");
            public static int RouteGradientColor = Shader.PropertyToID("_RouteGradientColor");
            public static int RouteTraveledColor = Shader.PropertyToID("_TraveledColor");
            public static int RouteTraveledSolid = Shader.PropertyToID("_TraveledSolid");
            public static int RouteZTest = Shader.PropertyToID("_ZTest");
            public static int RouteFade = Shader.PropertyToID("_RouteFade");
            public static int RouteFadeBand = Shader.PropertyToID("_RouteFadeBand");
            public static int RouteTex = Shader.PropertyToID("_RouteTex");
            public static int RouteTexLen = Shader.PropertyToID("_RouteTexLen");
        }
