...
namespace PixelCrushers.DialogueSystem.OpenAIAddon
{
    ...
    public abstract class TextGenerationPanel : BasePanel
    {
        ...
        protected TextModelName ModelName { get; private set; } = Model.DefaultTextModelName;
        protected Model Model { get; private set; } = Model.GPT5_6_Luna;
#if UNITY_2021_3_OR_NEWER
        protected bool IsChatModel =>
            Model.ModelType == ModelType.Chat ||
            Model.Name.Contains("gpt", System.StringComparison.OrdinalIgnoreCase) ||
            Model.ModelType == ModelType.Reasoning;
#else
        protected bool IsChatModel => 
            Model.ModelType == ModelType.Chat || 
            Model.Name.ToLower().Contains("gpt") ||
            Model.ModelType == ModelType.Reasoning;
#endif
        protected bool IsOllamaModel => Model.IsOllamaModel;
        protected string ServiceName => Model.ServiceName;
