...
namespace PixelCrushers.DialogueSystem.OpenAIAddon
{
    ...
    public class GeneratePortraitsPanel : BasePanel
    {
        ...
        private static string[] ImageSizes = new string[] { "1024x1024", "1024x1536", "1536x1024" };
        private static int[] ImageWidths = new int[] { 1024, 1024, 1536 };
        private static int[] ImageHeights = new int[] { 1024, 1536, 1024 };
        ...
        private int ImageWidth => ImageWidths[imageSizeIndex];
        private int ImageHeight => ImageHeights[imageSizeIndex];
        ...
        private void ReceivePortraits(Vector2Int size, List<string> b64_jsons)
        {
            IsAwaitingReply = false;
            ...
            for (int i = 0; i < b64_jsons.Count; i++)
            {
                ...
                var texture2D = new Texture2D(ImageWidth, ImageHeight);
