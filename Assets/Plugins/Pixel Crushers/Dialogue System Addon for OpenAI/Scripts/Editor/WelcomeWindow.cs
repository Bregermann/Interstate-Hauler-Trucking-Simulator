...
namespace PixelCrushers.DialogueSystem.OpenAIAddon
{
    ...
    public class WelcomeWindow : EditorWindow
    {
        ...
        private static GUIContent OpenAIKeyLabel = new GUIContent("OpenAI API Key", "The key you enter here is only used to access the OpenAI API while within the Unity editor.");
