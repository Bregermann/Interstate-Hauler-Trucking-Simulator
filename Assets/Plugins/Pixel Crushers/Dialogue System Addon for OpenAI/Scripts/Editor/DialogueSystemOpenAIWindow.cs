...
namespace PixelCrushers.DialogueSystem.OpenAIAddon
{
    ...
    public class DialogueSystemOpenAIWindow : EditorWindow
    {
        ...
        public const string CustomOllamaKey = "PixelCrushers.OpenAI.CustomOllama"; // Custom Ollama model name.
        public const string CustomOllamaURLKey = "PixelCrushers.OpenAI.OllamaURL"; // URL to talk to Ollama.
            ...
            DialogueDatabase database, Asset asset, DialogueEntry entry, Field field, TextTable textTable = null)
        {
            switch (request)
            {
                ...
                case AIRequestType.LocalizeEntry:
                    return new TranslateDialogueEntryPanel(apiKey, database, entry);
                ...
                case AIRequestType.GenerateVoice:
                    return (entry != null)
                        ? new GenerateVoicePanel(elevenLabsKey, database, asset, entry, field)
                        : new GenerateMultipleVoicesPanel(elevenLabsKey, database, asset);
        ...
        public static string customOllamaName;
        ...
        private void OnEnable()
        {
            ...
            customOllamaName = EditorPrefs.GetString(CustomOllamaKey);
            Model.CustomOllamaModel.Name = customOllamaName;
            OllamaAPI.currentOllamaURL = EditorPrefs.GetString(CustomOllamaURLKey, OllamaAPI.DefaultOllamaURL);
        }
        ...
        private void OnDisable()
        {
            ...
            EditorPrefs.SetString(CustomOllamaKey, customOllamaName);
            EditorPrefs.SetString(CustomOllamaURLKey, OllamaAPI.currentOllamaURL);
        }
        ...
        public void SetLocalizationLanguages(List<string> languages)
        {
            ...
            (panel as TranslateDialogueEntryPanel)?.SetLanguages(languages);
        }
