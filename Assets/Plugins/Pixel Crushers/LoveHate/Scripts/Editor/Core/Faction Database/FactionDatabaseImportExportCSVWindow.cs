...
namespace PixelCrushers.LoveHate
{
    ...
    public class FactionDatabaseImportExportCSVWindow : EditorWindow
    {
        ...
        public class Prefs
        {
            ...
            public EntityIdWrapper dbInstanceID = EntityIdWrapper.None;
        ...
        private void OnEnable()
        {
            ...
            if (prefs.dbInstanceID.isValid) db = MoreEditorUtility.InstanceIDToObject(prefs.dbInstanceID) as FactionDatabase;
        }

        private void OnDisable()
        {
            prefs.dbInstanceID = EntityUtility.GetEntityId(db);
