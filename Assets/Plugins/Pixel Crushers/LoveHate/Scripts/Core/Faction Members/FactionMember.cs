...
namespace PixelCrushers.LoveHate
{
    ...
    public class FactionMember : MonoBehaviour
    {
        ...
        [System.NonSerialized] public List<Rumor> shortTermMemory = new List<Rumor>();

        [Tooltip("Rumors are shared from long term memory.")]
        [System.NonSerialized] public List<Rumor> longTermMemory = new List<Rumor>();
        ...
        public void ChangeRuntimeFactionManager(FactionManager newFactionManager)
        {
            if (newFactionManager == null) return;
            if (newFactionManager == factionManager) return;
            if (factionManager != null) factionManager.UnregisterFactionMember(this);
