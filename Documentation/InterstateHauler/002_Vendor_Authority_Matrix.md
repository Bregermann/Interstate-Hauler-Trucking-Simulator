...
| Root save orchestration | LWS | `ILwsSaveService`, `ILwsSaveParticipant`, `ILwsSaveStorage` | Pixel Crushers Save System, Compass save, vendor-specific saves | Career state spans vendors and project systems. | Save foundation |
